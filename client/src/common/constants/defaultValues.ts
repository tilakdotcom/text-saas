...
export const demoText: string = `# DocWise: AI-Powered Document Summarizer 🧠📄
...
# Why It Matters
• 🧠 DocWise helps users save time and effort by auto - generating meaningful summaries of lengthy PDFs and text files.It empowers better comprehension and faster decision - making.
...
# Pro Tips
• 📌 Use DocWise to quickly scan academic papers or lengthy reports.
...
• ⚙️ OpenAI API: The engine behind DocWise’s smart summarization capabilities.

# Bottom Line
• 💫 DocWise is your go - to AI assistant for document summarization—fast, efficient, and built for clarity in the age of information overload.`;
